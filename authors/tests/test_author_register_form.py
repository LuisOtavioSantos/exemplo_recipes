...
class AuthorRegisterFormIntegrationTest(DjangoTestCase):
    ...
    def test_fields_cannot_be_empty(self, field, msg):
        ...
        url = reverse(viewname='authors:register_create')
    ...
    def test_created_user_can_login(self):
        ...
        self.form_data.update({
            ...
            'password': '@Bc123456',
            'password2': '@Bc123456',
            'email': 'tecontar@gmail.com'
        })

        self.client.post(path=url, data=self.form_data, follow=True)
        is_authenticated = self.client.login(
            username='testuser',
            password='@Bc123456',
        )

        self.assertEqual(first=is_authenticated, second=True)
